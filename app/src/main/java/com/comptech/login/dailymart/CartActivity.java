...
import com.comptech.login.dailymart.Model.Cart;
import com.comptech.login.dailymart.Prevalent.Prevalent;
import com.comptech.login.dailymart.ViewHolder.CartViewHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                txtTotalBtn.setText("Total Price= Rs" + String.valueOf(overallTotalPrice) );
